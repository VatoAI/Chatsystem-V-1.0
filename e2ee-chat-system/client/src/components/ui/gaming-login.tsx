...
// VideoBackground Component with Matrix Images
const VideoBackground: React.FC<VideoBackgroundProps> = ({ videoUrl, useMatrixImages = true }) => {
    ...
    if (useMatrixImages) {
        return (
            <div className="absolute inset-0 w-full h-full overflow-hidden">
                ...
                {/* Matrix Pills Background */}
                <div className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-matrix-pills" />
                
                {/* Matrix Code Rain Effect */}
                <div className="absolute inset-0 opacity-20">
                    <div className="absolute inset-0 bg-cover bg-center bg-matrix-code brightness-[0.3] hue-rotate-180" />
                </div>

                {/* Floating Matrix Pills */}
                <div className="absolute inset-0 overflow-hidden">
                    <img 
                        src="/istockphoto-1140916920-612x612.jpg" 
                        alt="Matrix Pills" 
                        className="absolute top-1/4 right-1/4 w-24 h-24 opacity-30 animate-pulse"
                    />
                    <img 
                        src="/istockphoto-1140916920-612x612.jpg" 
                        alt="Matrix Pills" 
                        className="absolute bottom-1/3 left-1/4 w-16 h-16 opacity-20 animate-bounce [animation-delay:1s]"
                    />
                </div>

                {/* Digital Rain Effect */}
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-green-900/10 to-black/30" />
            </div>
        );
    }
            ...
            <div className="mb-8 text-center">
                ...
                <p className="text-white/80 flex flex-col items-center space-y-1">
                    <span className="relative group cursor-default">
                        ...
                        <span className="relative inline-block animate-pulse">Choose your reality</span>
                    </span>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    ...
                    className={`w-full py-3 rounded-lg ${isSuccess
                            ? 'animate-success'
                            : 'bg-gradient-to-r from-red-600 via-purple-600 to-blue-600 hover:from-red-700 hover:via-purple-700 hover:to-blue-700'
                ...
                >
                    {isSubmitting ? 'Entering the Matrix...' : 'Enter the Matrix'}
                </button>
            </form>
